...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(true);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ":host {\n  display: block;\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  overflow-x: hidden;\n  overflow-y: auto;\n  padding: 10px;\n  background-image: linear-gradient(112.1deg, #073642 11.4%, #094959 70.2%);\n  background-attachment: fixed;\n}\n#server {\n  color: #93a1a1;\n  font-size: 20px;\n  font-weight: bolder;\n  text-transform: capitalize;\n  text-align: center;\n  padding-top: 5px;\n  padding-bottom: 15px;\n}\nth {\n  text-align: right;\n  font-weight: normal;\n  white-space: nowrap;\n}\nth[colspan] {\n  padding-top: 10px;\n  padding-bottom: 5px;\n  text-align: center;\n  font-weight: bold;\n  font-size: 15px;\n}\ninput,\nselect,\ntextarea {\n  color: #839496;\n  background-color: #002b36;\n  border: 1px solid #839496;\n}\nsettings-button + settings-button {\n  margin-top: 3px;\n}\n", "",{"version":3,"sources":["webpack://src/detail-view/detail-view.less","webpack://src/constants/mixins.less"],"names":[],"mappings":"AAEA;EACE,cAAA;EACA,kBAAA;EACA,MAAA;EACA,OAAA;EACA,QAAA;EACA,SAAA;EACA,kBAAA;EACA,gBAAA;EAEA,aAAA;ECuCA,yEAAA;EACA,4BAAA;ADxCF;AAKA;EACE,cAAA;EACA,eAAA;EACA,mBAAA;EACA,0BAAA;EAEA,kBAAA;EACA,gBAAA;EACA,oBAAA;AAJF;AAOA;EACE,iBAAA;EACA,mBAAA;EACA,mBAAA;AALF;AAQA;EACE,iBAAA;EACA,mBAAA;EAEA,kBAAA;EACA,iBAAA;EACA,eAAA;AAPF;AAUA;;;EACE,cAAA;EACA,yBAAA;EAEA,yBAAA;AAPF;AAUA;EACE,eAAA;AARF","sourcesContent":["@import \"../constants/common.less\";\n\n:host {\n  display: block;\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  overflow-x: hidden;\n  overflow-y: auto;\n\n  padding: 10px;\n\n  .grad(@bgColorHighlight);\n}\n\n#server {\n  color: @titleTextColor;\n  font-size: 20px;\n  font-weight: bolder;\n  text-transform: capitalize;\n\n  text-align: center;\n  padding-top: 5px;\n  padding-bottom: 15px;\n}\n\nth {\n  text-align: right;\n  font-weight: normal;\n  white-space: nowrap;\n}\n\nth[colspan] {\n  padding-top: 10px;\n  padding-bottom: 5px;\n\n  text-align: center;\n  font-weight: bold;\n  font-size: 15px;\n}\n\ninput, select, textarea {\n  color: @mainTextColor;\n  background-color: @bgColor;\n\n  border: 1px solid @mainTextColor;\n}\n\nsettings-button + settings-button {\n  margin-top: 3px;\n}","@import \"colors.less\";\n\n.mark(@color) {\n  border-left: 3px solid @color;\n  border-color: @color;\n}\n\n.mark-success() {\n  .mark(@colorOk);\n}\n\n.mark-failure() {\n  .mark(@colorNg);\n}\n\n.button-style(@background: @bgColorHighlight,\n              @text: @mainTextColor,\n              @hover:@bgColorSelected) {\n  :host {\n    .button-style-elem(@background, @text, @hover);\n  }\n\n  :host(:hover) {\n    .button-style-hover(@background, @text, @hover);\n  }\n}\n\n.button-style-elem(@background: @bgColorHighlight,\n              @text: @mainTextColor,\n              @hover:@bgColorSelected) {\n  padding: 5px;\n\n  color: @text;\n  .grad(@background);\n\n  text-transform: capitalize;\n\n  cursor: pointer;\n  transition: background-color 300ms, color 300ms;\n}\n\n.button-style-hover(@background: @bgColorHighlight,\n              @text: @mainTextColor,\n              @hover:@bgColorSelected) {\n  .grad(@background);\n  background-color: @hover;\n\n  color: @textColorSelected;\n}\n\n.grad(@baseColor) {\n  background-image: linear-gradient(112.1deg, @baseColor 11.4%, lighten(@baseColor, 5%) 70.2%);\n  background-attachment: fixed;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
function _templateObject() {
  var data = _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_2___default()(["<icon-svg .icon=\"", "\"></icon-svg>\n        <div class=\"title\">", "</div>\n        ", ""]);
