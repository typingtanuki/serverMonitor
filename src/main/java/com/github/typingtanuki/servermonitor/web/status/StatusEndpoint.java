...
public class StatusEndpoint {
    ...
    public StatusResponse status() {
        ...
        return new StatusResponse(monitor.currentConfig().getIdentity(), monitor.currentStatus().getStatus());
    }
    ...
    public ShortStatusResponse shortStatus() {
        ServerMonitor monitor = MonitorMain.monitor;
        return new ShortStatusResponse(monitor.currentConfig().getIdentity(), monitor.currentStatus().getStatus());
    }
